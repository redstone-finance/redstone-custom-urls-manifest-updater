...
const Modal = ({ isOpen, setIsOpen, title, text }: Props) => {
  if (!isOpen) {
    return <></>;
  }
  ...
  return (
    <div className="fixed top-0 z-50 w-screen h-screen bg-gray-400 bg-opacity-60">
      <div className="relative mx-auto w-full max-w-2xl mt-20">
        <div className="relative bg-white rounded-lg shadow bg-white p-4">
